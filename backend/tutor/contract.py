...
TUTOR_RESPONSE_SCHEMA = (
    ...
    "\"next_action\":\"one self-contained unsolved question including all needed values\",\"hint_level\":1,"
    "\"current_step\":1,\"total_steps\":3,"
    "\"expected_step_answer\":\"hidden answer to that new question, not the old attempt\","
