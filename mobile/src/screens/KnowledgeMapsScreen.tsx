...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    libraryScroll: { width: '100%', maxWidth: layout.contentMaxWidth, alignSelf: 'center', paddingHorizontal: 4, paddingTop: Math.max(topInset + 10, 50), paddingBottom: 110, gap: 13 },
    ...
    libraryHero: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 4, gap: 14, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    heroCopyBlock: { gap: 4 },
    ...
    recommendedSection: { borderRadius: 21, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.8), padding: 4, gap: 11 },
    ...
    recommendedChip: { maxWidth: 210, height: 38, borderRadius: 12, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(theme.panelAlt, 0.8), flexDirection: 'row', alignItems: 'center', gap: 7, paddingHorizontal: 3 },
    ...
    libraryMapBody: { flex: 1, padding: 4, justifyContent: 'space-between' },
    ...
    openMapPill: { borderRadius: 9, backgroundColor: theme.accent, flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 2, paddingVertical: 2 },
    openMapText: { fontFamily: 'Inter_900Black', color: accentInk, fontSize: 7.5, letterSpacing: 0.7 },
    empty: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.84), alignItems: 'center', paddingVertical: 12, paddingHorizontal: 6, gap: 9 },
    ...
    mapScreen: { flex: 1, paddingTop: Math.max(topInset + 8, 48), paddingHorizontal: 3, paddingBottom: 3, gap: 9 },
    ...
    statusPill: { height: 27, borderRadius: 9, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.82), flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 2 },
    ...
    graphNodeMain: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 9, paddingHorizontal: 3, paddingTop: 2 },
    ...
    zoomControls: { position: 'absolute', left: 10, right: 10, bottom: 10, minHeight: 46, borderRadius: 15, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.96), flexDirection: 'row', alignItems: 'center', paddingHorizontal: 2, gap: 3, boxShadow: cbTileShadow(0.12) } as ViewStyle,
    ...
    graphGestureHint: { position: 'absolute', top: 10, alignSelf: 'center', height: 29, borderRadius: 10, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 3 },
    ...
    nodeSheetHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, paddingHorizontal: 5, paddingTop: 4 },
    ...
    sheetScroll: { padding: 5, paddingBottom: 42, gap: 11 },
    learningCard: { borderRadius: 19, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.8), padding: 4, gap: 10 },
    ...
    conceptChip: { fontFamily: 'Inter_700Bold', color: theme.textPrimary, fontSize: 9, borderRadius: 999, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(theme.panelAlt, 0.8), paddingHorizontal: 2, paddingVertical: 2 },
    exampleRow: { flexDirection: 'row', gap: 10, borderTopWidth: 1, borderTopColor: theme.border, paddingTop: 2 },
    ...
    learnEmpty: { minHeight: 270, borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.78), alignItems: 'center', justifyContent: 'center', padding: 6, gap: 9 },
    ...
    sheetForm: { flex: 1, padding: 5, gap: 11 },
    formLabel: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 9, letterSpacing: 1.4 },
    input: { minHeight: 50, borderRadius: 14, borderWidth: 1, borderColor: border, paddingHorizontal: 4, color: theme.textPrimary, backgroundColor: rgbaFromHex(surface, 0.92), fontFamily: 'Inter_600SemiBold', fontSize: 12 },
    notesInput: { minHeight: 230, paddingTop: 4 },
    askInput: { minHeight: 112, paddingTop: 4 },
    primaryBtn: { minHeight: 48, borderRadius: 14, backgroundColor: theme.accent, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 4 },
    primaryText: { fontFamily: 'Inter_900Black', color: accentInk, fontSize: 9, letterSpacing: 1 },
    answerScroll: { flex: 1 },
    answerCard: { borderRadius: 19, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.82), padding: 4 },
    createHeader: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12, padding: 5 },
    createTitle: { fontFamily: 'Inter_900Black', color: theme.accentHover, fontSize: 23, lineHeight: 28, marginTop: 4, maxWidth: 310 },
    createBody: { paddingHorizontal: 5, gap: 12 },
