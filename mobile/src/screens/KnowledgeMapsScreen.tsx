...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    mapKicker: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 10, letterSpacing: 1.7 },
    ...
    heroMetricLabel: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 10, letterSpacing: 1, textTransform: 'uppercase' },
    ...
    sectionKicker: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 10, letterSpacing: 1.4 },
    ...
    openMapText: { fontFamily: 'Inter_900Black', color: accentInk, fontSize: 10, letterSpacing: 0.7 },
    ...
    mapScreen: { flex: 1, paddingTop: Math.max(topInset + 8, 48), paddingHorizontal: 3, paddingBottom: 12, gap: 9 },
    ...
    statusText: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 10 },
    mapHint: { flex: 1, fontFamily: 'Inter_400Regular', color: theme.textSecondary, fontSize: 10, textAlign: 'right' },
    ...
    graphNodeMeta: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 10, marginTop: 3 },
    ...
    graphNodeActionText: { fontFamily: 'Inter_700Bold', color: theme.accentHover, fontSize: 9.5, letterSpacing: 0.55 },
    ...
    zoomValue: { width: 39, textAlign: 'center', fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 10 },
    ...
    zoomBtnText: { fontFamily: 'Inter_700Bold', color: theme.accentHover, fontSize: 9.5, letterSpacing: 0.5 },
    ...
    graphGestureText: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 10 },
    ...
    nodeSheetKicker: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 10, letterSpacing: 1.5 },
    ...
    nodeMetricLabel: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 10, textTransform: 'uppercase', letterSpacing: 0.7 },
    ...
    secondaryActionText: { fontFamily: 'Inter_700Bold', color: theme.accentHover, fontSize: 10, letterSpacing: 0.6 },
