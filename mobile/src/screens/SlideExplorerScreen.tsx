...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    uploadBtn: { height: 40, borderRadius: 12, backgroundColor: theme.accentHover, paddingHorizontal: 3, flexDirection: 'row', alignItems: 'center', gap: 7, boxShadow: cbTileShadow(0.055) },
    uploadText: { fontFamily: 'Inter_900Black', color: accentInk, fontSize: 11, textTransform: 'uppercase', letterSpacing: 1 },
    readerTopInfo: { flex: 1, paddingHorizontal: 3 },
    ...
    hero: { borderRadius: 22, padding: 5, overflow: 'hidden', boxShadow: cbModalShadow(0.14) } as ViewStyle,
    ...
    summaryStrip: { minHeight: 48, borderTopWidth: 1, borderBottomWidth: 1, borderColor: border, flexDirection: 'row', alignItems: 'center', paddingVertical: 2 },
    ...
    slideCard: { borderTopWidth: 1, borderColor: border, paddingTop: 5, gap: 12 },
    slideTitleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 10 },
    ...
    insightsToggle: { minHeight: 62, paddingHorizontal: 3, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    ...
    insightsBody: { padding: 3, paddingTop: 0, gap: 18 },
    insightSection: { gap: 9 },
    insightSectionHead: { flexDirection: 'row', alignItems: 'center', gap: 7 },
    ...
    conceptChip: { borderRadius: 9, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(theme.accent, 0.08), paddingHorizontal: 3, paddingVertical: 2 },
    conceptText: { fontFamily: 'Inter_600SemiBold', color: theme.textPrimary, fontSize: 11 },
    definitionCard: { width: '100%', borderRadius: 11, borderWidth: 1, borderColor: border, padding: 3, backgroundColor: rgbaFromHex(surface, 0.64) },
    ...
    questionCard: { width: '100%', borderRadius: 11, borderWidth: 1, borderColor: border, padding: 3, gap: 7, backgroundColor: rgbaFromHex(surface, 0.64) },
    ...
    tipRow: { width: '100%', flexDirection: 'row', gap: 10, alignItems: 'flex-start' },
    ...
    list: { gap: 12 },
    deckCard: { borderRadius: 16, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 13, boxShadow: cbTileShadow(0.07) } as ViewStyle,
