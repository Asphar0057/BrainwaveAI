...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>) {
  ...
  return StyleSheet.create({
    ...
    summaryLabel: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 10, marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.7 },
    ...
    navCount: { textAlign: 'center', fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 9, letterSpacing: 1, marginTop: 3 },
    slideCard: { borderTopWidth: 1, borderColor: border, paddingTop: 18, gap: 12 },
    ...
    insightsBody: { padding: 13, paddingTop: 0, gap: 18 },
