...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    actionGrid: { gap: 11 },
    bigAction: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, flexDirection: 'row', alignItems: 'center', gap: 12, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    ...
    sectionHead: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, boxShadow: cbTileShadow(0.055) } as ViewStyle,
    ...
    list: { gap: 11 },
    noteCard: { borderRadius: 20, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, flexDirection: 'row', alignItems: 'center', gap: 12, boxShadow: cbTileShadow(0.055) } as ViewStyle,
