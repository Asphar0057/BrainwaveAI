...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    actionGrid: { gap: 4 },
    bigAction: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 15, flexDirection: 'row', alignItems: 'center', gap: 4, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    ...
    list: { gap: 4 },
    noteCard: { borderRadius: 20, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 14, flexDirection: 'row', alignItems: 'center', gap: 4, boxShadow: cbTileShadow(0.055) } as ViewStyle,
