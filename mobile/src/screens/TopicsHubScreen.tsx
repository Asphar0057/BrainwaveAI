...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    summaryCard: { flex: 1, minHeight: 86, borderRadius: 18, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.8), padding: 3, justifyContent: 'center', boxShadow: cbTileShadow(0.045) } as ViewStyle,
    ...
    priorityCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 4, gap: 13, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    ...
    filterBtn: { flex: 1, borderRadius: 13, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.76), alignItems: 'center', justifyContent: 'center', paddingHorizontal: 1 },
    ...
    listCard: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.82), padding: 4, gap: 3, boxShadow: cbTileShadow(0.06) } as ViewStyle,
    listHeader: { minHeight: 49, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', paddingBottom: 2 },
    ...
    topicRow: { minHeight: 82, borderTopWidth: 1, borderTopColor: theme.border, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 3 },
    ...
    severityPill: { borderRadius: 999, paddingHorizontal: 2, paddingVertical: 1 },
    ...
    empty: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.82), alignItems: 'center', paddingVertical: 14, paddingHorizontal: 6, gap: 9 },
    ...
    emptyInline: { fontFamily: 'Inter_400Regular', color: theme.textSecondary, fontSize: 11, paddingVertical: 5, textAlign: 'center' },
