...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    searchBox: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 18, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), paddingHorizontal: 14, boxShadow: cbTileShadow(0.055) } as ViewStyle,
    ...
    list: { gap: 4 },
    setCard: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 16, gap: 4, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    setTop: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    ...
    questionCard: { borderWidth: 1, borderColor: border, borderRadius: 24, backgroundColor: rgbaFromHex(surface, 0.72), padding: 18, gap: 4, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    questionMetaRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 4 },
    ...
    explainBox: { borderTopWidth: 1, borderTopColor: theme.border, paddingTop: 14, gap: 4 },
    ...
    practiceActions: { flexDirection: 'row', gap: 4 },
    ...
    modalBody: { padding: 20, paddingBottom: 46, gap: 4 },
    ...
    choiceRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 4 },
