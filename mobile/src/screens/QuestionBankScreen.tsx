...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    searchBox: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 18, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), paddingHorizontal: 4, boxShadow: cbTileShadow(0.055) } as ViewStyle,
    searchInput: { flex: 1, color: theme.textPrimary, fontFamily: 'Inter_600SemiBold', fontSize: 14, paddingVertical: 3 },
    ...
    list: { gap: 12 },
    setCard: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 14, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    ...
    pill: { alignSelf: 'flex-start', borderWidth: 1, borderColor: theme.border, borderRadius: 999, paddingHorizontal: 2, paddingVertical: 1, color: theme.textSecondary, fontFamily: 'Inter_700Bold', fontSize: 10, textTransform: 'uppercase', letterSpacing: 1 },
    deleteBtn: { width: 32, height: 32, alignItems: 'center', justifyContent: 'center' },
    questionCard: { borderWidth: 1, borderColor: border, borderRadius: 24, backgroundColor: rgbaFromHex(surface, 0.72), padding: 5, gap: 16, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    ...
    options: { gap: 10 },
    option: { borderWidth: 1, borderColor: rgbaFromHex(theme.accentHover, 0.12), backgroundColor: rgbaFromHex(theme.panelAlt, 0.86), borderRadius: 16, paddingHorizontal: 4, paddingVertical: 3 },
    ...
    answerInput: { minHeight: 110, borderWidth: 1, borderColor: theme.border, borderRadius: 13, padding: 4, color: theme.textPrimary, backgroundColor: rgbaFromHex(theme.panelAlt, 0.86), textAlignVertical: 'top', fontFamily: 'Inter_600SemiBold' },
    explainBox: { borderTopWidth: 1, borderTopColor: theme.border, paddingTop: 4, gap: 8 },
    ...
    resultCard: { borderRadius: 22, borderWidth: 1, borderColor: rgbaFromHex(theme.accent, 0.32), backgroundColor: rgbaFromHex(theme.accent, 0.11), padding: 5, alignItems: 'center', boxShadow: cbTileShadow(0.055) } as ViewStyle,
    ...
    modalBody: { padding: 5, paddingBottom: 46, gap: 12 },
    ...
    input: { minHeight: 48, borderRadius: 13, borderWidth: 1, borderColor: border, paddingHorizontal: 4, color: theme.textPrimary, backgroundColor: rgbaFromHex(surface, 0.92), fontFamily: 'Inter_600SemiBold' },
    choiceRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
    choice: { borderRadius: 999, borderWidth: 1, borderColor: theme.border, paddingHorizontal: 3, paddingVertical: 2, backgroundColor: rgbaFromHex(surface, 0.78) },
