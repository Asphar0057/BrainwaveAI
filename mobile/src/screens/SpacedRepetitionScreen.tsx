...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    dueCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 5, gap: 14, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    ...
    dueKicker: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 8, letterSpacing: 1.4 },
    ...
    statsCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 4, gap: 12, boxShadow: cbTileShadow(0.06) } as ViewStyle,
    statsTitle: { fontFamily: 'Inter_700Bold', color: theme.textPrimary, fontSize: 13, letterSpacing: 0.2 },
    summaryRow: { flexDirection: 'row', gap: 8 },
    summaryCard: { flex: 1, borderRadius: 14, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(theme.bgPrimary, theme.isLight ? 0.4 : 0.55), paddingVertical: 3, alignItems: 'center', gap: 3 },
    ...
    tipsCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 4, gap: 10, boxShadow: cbTileShadow(0.06) } as ViewStyle,
    tipsHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    tipsRefresh: { paddingHorizontal: 3, paddingVertical: 2, borderRadius: 10, backgroundColor: theme.accent },
    ...
    problemRow: { borderLeftWidth: 2, borderLeftColor: theme.accent, paddingLeft: 2, gap: 2 },
    ...
    // studying phase
    studyHeader: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 4, paddingTop: Math.max(topInset + 8, 46), paddingBottom: 2 },
    ...
    cardWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 5 },
    studyCard: {
      ...
      padding: 6, alignItems: 'center', justifyContent: 'center', gap: 14,
    ...
    gradeRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 4, paddingBottom: Math.max(20, layout.height < 700 ? 14 : 28) },
    gradeRowPlaceholder: { alignItems: 'center', paddingBottom: Math.max(30, layout.height < 700 ? 20 : 40) },
    gradeBtn: { flex: 1, borderRadius: 16, borderWidth: 1, paddingVertical: 3, alignItems: 'center', gap: 3 },
    ...
    // results phase
    resultsWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 6, gap: 8 },
