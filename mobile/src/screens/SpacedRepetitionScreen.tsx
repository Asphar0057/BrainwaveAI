...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    header: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: 4 },
    ...
    dueCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 18, gap: 4, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    dueTop: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    ...
    dueBreakdown: { flexDirection: 'row', flexWrap: 'wrap', gap: 4 },
    dueBreakdownItem: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 11 },

    primaryBtn: { height: 46, borderRadius: 14, backgroundColor: theme.accent, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
    primaryBtnDisabled: { opacity: 0.5 },
    primaryBtnText: { fontFamily: 'Inter_900Black', color: accentInk, fontSize: 12, letterSpacing: 0.8, textTransform: 'uppercase' },

    statsCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 16, gap: 4, boxShadow: cbTileShadow(0.06) } as ViewStyle,
    ...
    distributionRow: { flexDirection: 'row', gap: 4 },
    ...
    tipsCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 16, gap: 4, boxShadow: cbTileShadow(0.06) } as ViewStyle,
    ...
    tipRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 4 },
    ...
    studyCard: {
      ...
      padding: 24, alignItems: 'center', justifyContent: 'center', gap: 4,
    ...
    gradeRow: { flexDirection: 'row', gap: 4, paddingHorizontal: 16, paddingBottom: Math.max(20, layout.height < 700 ? 14 : 28) },
    ...
    // results phase
    resultsWrap: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 24, gap: 4 },
    ...
    resultsGrid: { flexDirection: 'row', gap: 5, marginVertical: 20 },
