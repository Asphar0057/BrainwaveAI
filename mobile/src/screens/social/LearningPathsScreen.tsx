...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    headerCopy: { flex: 1 },
    kicker: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 8, letterSpacing: 1.55 },
    ...
    resumeActionLabel: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 6.5, letterSpacing: 0.8 },
    ...
    summaryLabel: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 7.5, textTransform: 'uppercase', letterSpacing: 0.7 },
    ...
    filterText: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 7.5, letterSpacing: 0.6 },
    ...
    filterCountText: { fontFamily: 'Inter_900Black', color: theme.textSecondary, fontSize: 7.5 },
    ...
    pathDifficulty: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 7.5, letterSpacing: 1.2 },
    ...
    pathCardModules: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 6.5, letterSpacing: 0.9, textAlign: 'center' },
    ...
    cardProgressLabel: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 7, letterSpacing: 1.2 },
    ...
    cardSource: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 6.5, letterSpacing: 0.7 },
    cardMetrics: { flexDirection: 'row', gap: 13 },
    cardMetric: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    cardMetricText: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 8.5 },
    ...
    emptyBtnText: { fontFamily: 'Inter_900Black', color: ink, fontSize: 8.5, letterSpacing: 0.8 },
    ...
    compactStatLabel: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 6, letterSpacing: 0.6 },
    ...
    navStepNumber: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 6.5, letterSpacing: 0.8 },
    ...
    focusedMetricLabel: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 6.5, textTransform: 'uppercase', letterSpacing: 0.45 },
    ...
    openModuleBtnText: { fontFamily: 'Inter_900Black', color: ink, fontSize: 8.5, letterSpacing: 0.8 },
    ...
    pagerBtnText: { fontFamily: 'Inter_700Bold', color: theme.accentHover, fontSize: 7.5, letterSpacing: 0.65 },
    ...
    pathStatLabel: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 6.5, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    moduleNumber: { fontFamily: 'Inter_700Bold', color: theme.accent, fontSize: 7.5, letterSpacing: 1.2 },
    ...
    moduleStatusText: { fontFamily: 'Inter_900Black', color: theme.textSecondary, fontSize: 6.5, letterSpacing: 0.6 },
    ...
    moduleMetaText: { fontFamily: 'Inter_600SemiBold', color: theme.textSecondary, fontSize: 8 },
    moduleOpenText: { fontFamily: 'Inter_700Bold', color: theme.accentHover, fontSize: 7, letterSpacing: 0.6 },
    ...
    nodeInfoText: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 7.5, letterSpacing: 0.5 },
    ...
    outlineIndex: { fontFamily: 'Inter_900Black', color: theme.accent, fontSize: 8 },
    ...
    formLabel: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 8, letterSpacing: 1.2, marginTop: 4 },
    ...
    optionText: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 7.5, letterSpacing: 0.5 },
    optionTextActive: { color: ink },
    optionHint: { fontFamily: 'Inter_400Regular', color: theme.textSecondary, fontSize: 7 },
