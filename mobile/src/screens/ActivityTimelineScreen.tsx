...
function createStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    chip: { paddingHorizontal: 4, paddingVertical: 2, borderRadius: 999, borderWidth: 1, borderColor: BORDER, backgroundColor: SURFACE, boxShadow: cbTileShadow(0.035) },
    ...
    card: { flex: 1, backgroundColor: SURFACE, borderRadius: 22, borderWidth: 1, borderColor: BORDER, padding: 4, marginBottom: 10, gap: 4, boxShadow: cbTileShadow(0.06) } as ViewStyle,
