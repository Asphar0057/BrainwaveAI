...
function createStyles(layout: ReturnType<typeof useResponsiveLayout>) {
  ...
  workspaceActions: { flexDirection: 'row', gap: 4, marginBottom: 12 },
  generateAction: { flex: 1, height: 52, borderRadius: 17, backgroundColor: BASE_ACTION_BG, borderWidth: 1, borderColor: BASE_ACTION_BORDER, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
  generateActionText: { fontFamily: 'Inter_700Bold', fontSize: 12, color: BASE_ACTION_TEXT, letterSpacing: 0.4, textTransform: 'uppercase' },
  manualAction: { width: 92, height: 52, borderRadius: 17, borderWidth: 1, borderColor: BORDER, backgroundColor: rgbaFromHex(SURFACE, 0.9), flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
  randomAction: { width: 92, height: 52, borderRadius: 17, borderWidth: 1, borderColor: softAccentBorder, backgroundColor: softAccent, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
  manualActionText: { fontFamily: 'Inter_700Bold', fontSize: 11, color: GOLD_L, letterSpacing: 0.4, textTransform: 'uppercase' },
  workspaceNav: { height: 42, flexDirection: 'row', gap: 4, marginBottom: 10 },
  ...
  collectionStudyBtn: { height: 36, borderRadius: 11, backgroundColor: BASE_ACTION_BG, borderWidth: 1, borderColor: BASE_ACTION_BORDER, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
  collectionStudyText: { fontFamily: 'Inter_900Black', fontSize: 9, color: BASE_ACTION_TEXT, letterSpacing: 1.1 },
  statsWorkspace: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', gap: 4, alignContent: 'flex-start' },
  ...
  libraryHeader: { gap: 4, marginBottom: 4 },
  continueCard: {
    borderRadius: 24,
    borderWidth: 1,
  ...
  continueEyebrowRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  ...
  libraryStatsRow: { flexDirection: 'row', gap: 4 },
  ...
  createRow: { flexDirection: 'row', gap: 4 },
  createBtnPrimary: {
    flex: 1, minHeight: 68, flexDirection: 'row', alignItems: 'center',
    gap: 4, backgroundColor: BASE_ACTION_BG, borderRadius: 20, paddingVertical: 12, paddingHorizontal: 16,
    borderWidth: 1,
    borderColor: softAccentBorder,
  },
  ...
  searchBox: { minHeight: 48, borderRadius: 16, borderWidth: 1, borderColor: BORDER, backgroundColor: rgbaFromHex(INPUT_BG, 0.94), paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 4 },
  searchInput: { flex: 1, color: INPUT_TEXT, fontFamily: 'Inter_400Regular', fontSize: 13, paddingVertical: 12 },
  filterRow: { flexDirection: 'row', gap: 4, marginBottom: 2 },
  ...
  setCardBody: { flex: 1, minWidth: 0, gap: 4 },
  ...
  setCardTop: { flexDirection: 'row', alignItems: 'flex-start', gap: 4 },
  ...
  masteryRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 1 },
  ...
  empty: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 4, paddingVertical: 50 },
  ...
  reviewToggle: { minHeight: 28, borderRadius: 999, paddingHorizontal: 9, borderWidth: 1, borderColor: QUESTION_CHIP_BORDER, backgroundColor: QUESTION_CHIP_BG, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
