...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    hsToggle: { height: 40, borderRadius: 16, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), paddingHorizontal: 3, flexDirection: 'row', alignItems: 'center', gap: 7, boxShadow: cbTileShadow(0.055) },
    ...
    hero: { borderRadius: 30, padding: 5, overflow: 'hidden', boxShadow: cbModalShadow(0.14) } as ViewStyle,
    ...
    metric: { flex: 1, borderWidth: 1, borderColor: rgbaFromHex(theme.accentHover, 0.12), borderRadius: 16, padding: 3, backgroundColor: rgbaFromHex(theme.panelAlt, 0.74) },
    ...
    sectionStack: { gap: 13 },
    actionPanel: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, flexDirection: layout.twoColumn ? 'row' : 'column', gap: 14, alignItems: layout.twoColumn ? 'center' : 'stretch', boxShadow: cbTileShadow(0.08) } as ViewStyle,
    ...
    actionIcon: { minWidth: 62, borderRadius: 16, borderWidth: 1, borderColor: rgbaFromHex(theme.accentHover, 0.14), backgroundColor: rgbaFromHex(theme.accent, 0.1), paddingHorizontal: 3, paddingVertical: 3, alignItems: 'center', gap: 5 },
    ...
    relatedBox: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 12, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    chipWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
    chip: { borderRadius: 999, borderWidth: 1, borderColor: theme.border, backgroundColor: rgbaFromHex(theme.panelAlt, 0.82), paddingHorizontal: 3, paddingVertical: 2 },
    chipText: { fontFamily: 'Inter_700Bold', color: theme.textPrimary, fontSize: 12 },
    cardList: { gap: 11 },
    docCard: { borderRadius: 20, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 3, flexDirection: 'row', alignItems: 'center', gap: 10, boxShadow: cbTileShadow(0.055) } as ViewStyle,
    ...
    composer: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 12, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    ...
    answerCard: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 10, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    answerText: { fontFamily: 'Inter_400Regular', color: theme.textPrimary, fontSize: 14, lineHeight: 22 },
    sourceList: { gap: 8, marginTop: 4 },
    sourceRow: { borderTopWidth: 1, borderTopColor: theme.border, paddingTop: 2 },
    ...
    resultCard: { borderRadius: 18, borderWidth: 1, borderColor: rgbaFromHex(theme.accentHover, 0.12), backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 7, boxShadow: cbTileShadow(0.045) } as ViewStyle,
    ...
    suggestionPanel: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 12, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    conceptCard: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, gap: 11, boxShadow: cbTileShadow(0.07) } as ViewStyle,
    ...
    reviewCard: { borderRadius: 20, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, flexDirection: 'row', alignItems: 'center', gap: 12, boxShadow: cbTileShadow(0.055) } as ViewStyle,
    ...
    commandCard: { borderRadius: 18, borderWidth: 1, borderColor: rgbaFromHex(theme.accentHover, 0.12), backgroundColor: rgbaFromHex(surface, 0.72), padding: 4, boxShadow: cbTileShadow(0.045) } as ViewStyle,
    ...
    empty: { alignItems: 'center', paddingVertical: 12, gap: 9 },
    ...
    modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 5, paddingTop: 6, paddingBottom: 3 },
    modalTitle: { fontFamily: 'Inter_900Black', color: theme.accentHover, fontSize: 25 },
    modalBody: { padding: 5, gap: 12 },
    label: { fontFamily: 'Inter_700Bold', color: theme.textSecondary, fontSize: 10, letterSpacing: 1.6, textTransform: 'uppercase' },
    input: { minHeight: 50, borderRadius: 13, borderWidth: 1, borderColor: border, paddingHorizontal: 4, color: theme.textPrimary, backgroundColor: rgbaFromHex(surface, 0.92), fontFamily: 'Inter_600SemiBold' },
    textArea: { minHeight: 110, paddingTop: 3, textAlignVertical: 'top' },
    reviewPrompt: { fontFamily: 'Inter_900Black', color: theme.textPrimary, fontSize: 17, lineHeight: 23 },
    reviewInput: { minHeight: 190, paddingTop: 3, textAlignVertical: 'top' },
  });
}
