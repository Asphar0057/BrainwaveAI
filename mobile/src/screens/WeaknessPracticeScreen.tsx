...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    priorityCard: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 16, gap: 4, boxShadow: cbTileShadow(0.08) } as ViewStyle,
    priorityTop: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    ...
    primaryPracticeBtn: { height: 43, borderRadius: 13, backgroundColor: theme.accent, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 },
    ...
    filterRow: { height: 42, flexDirection: 'row', gap: 4 },
    ...
    topicRow: { minHeight: 82, borderTopWidth: 1, borderTopColor: theme.border, flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: 10 },
    ...
    topicBody: { flex: 1, gap: 4 },
    topicTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
    ...
    empty: { borderRadius: 24, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.82), alignItems: 'center', paddingVertical: 54, paddingHorizontal: 24, gap: 4 },
