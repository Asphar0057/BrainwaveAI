...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    empty: { alignItems: 'center', gap: 8, paddingVertical: 15, paddingHorizontal: 5 },
    ...
    emptyInline: { fontFamily: 'Inter_400Regular', color: theme.textSecondary, fontSize: 12, textAlign: 'center', paddingVertical: 5 },

    badgeRow: { flexDirection: 'row' },
    badge: { paddingHorizontal: 3, paddingVertical: 2, borderRadius: 10, backgroundColor: rgbaFromHex(theme.accent, theme.isLight ? 0.12 : 0.16) },
    badgeText: { fontFamily: 'Inter_700Bold', color: theme.accentHover, fontSize: 10.5 },

    warmup: { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 14, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), paddingHorizontal: 3, paddingVertical: 3 },
    warmupText: { flex: 1, fontFamily: 'Inter_400Regular', color: theme.textSecondary, fontSize: 11, lineHeight: 16 },

    tabRow: { flexDirection: 'row', gap: 6, borderRadius: 14, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.7), padding: 1 },
    tabBtn: { flex: 1, paddingVertical: 2, borderRadius: 10, alignItems: 'center' },
    ...
    summaryCard: { flex: 1, borderRadius: 16, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), paddingVertical: 4, paddingHorizontal: 2, alignItems: 'center', gap: 4 },
    ...
    card: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 4, gap: 12, boxShadow: cbTileShadow(0.06) } as ViewStyle,
    ...
    strategyBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 4, paddingVertical: 3 },
    ...
    strategyDetail: { paddingHorizontal: 4, paddingBottom: 4, gap: 10, borderTopWidth: 1, borderTopColor: border, paddingTop: 3 },
    ...
    chipGood: { paddingHorizontal: 2, paddingVertical: 1, borderRadius: 9, backgroundColor: rgbaFromHex(theme.success, 0.14) },
    chipGoodText: { fontFamily: 'Inter_600SemiBold', color: theme.success, fontSize: 10 },
    chipBad: { paddingHorizontal: 2, paddingVertical: 1, borderRadius: 9, backgroundColor: rgbaFromHex(theme.danger, 0.12) },
    chipBadText: { fontFamily: 'Inter_600SemiBold', color: theme.danger, fontSize: 10 },

    policyRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 3 },
