...
function createStyles(theme: ReturnType<typeof useAppTheme>['selectedTheme'], layout: ReturnType<typeof useResponsiveLayout>, topInset: number) {
  ...
  return StyleSheet.create({
    ...
    empty: { alignItems: 'center', gap: 4, paddingVertical: 60, paddingHorizontal: 20 },
    ...
    warmup: { flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 14, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), paddingHorizontal: 12, paddingVertical: 10 },
    warmupText: { flex: 1, fontFamily: 'Inter_400Regular', color: theme.textSecondary, fontSize: 11, lineHeight: 16 },

    tabRow: { flexDirection: 'row', gap: 4, borderRadius: 14, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.7), padding: 4 },
    ...
    card: { borderRadius: 22, borderWidth: 1, borderColor: border, backgroundColor: rgbaFromHex(surface, 0.9), padding: 16, gap: 4, boxShadow: cbTileShadow(0.06) } as ViewStyle,
    ...
    strategyBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 14, paddingVertical: 13 },
    ...
    strategyDetail: { paddingHorizontal: 14, paddingBottom: 14, gap: 4, borderTopWidth: 1, borderTopColor: border, paddingTop: 10 },
    strategyStatsRow: { flexDirection: 'row', gap: 4 },
    strategyStat: { gap: 2 },
    ...
    policyRow: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: 10 },
